"""
Django settings for guru_40418 project.
...
WSGI_APPLICATION = 'guru_40418.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "guru_40418 API",
    "DESCRIPTION": "API documentation for guru_40418 App",
    "VERSION": "v1",
}
